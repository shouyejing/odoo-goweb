...
class stock_inventory(models.Model):
    ...
    def _get_available_filters(self):
        res = super(stock_inventory, self)._get_available_filters(self._cr, self._uid, context=self._context)
    ...
    def prepare_inventory(self):
        ...
        if self.filter in ["invenory_plus", "inventory_update"]:
            ...
            return super(stock_inventory, self).prepare_inventory(self._cr, self._uid, [self.id], context=self._context)
