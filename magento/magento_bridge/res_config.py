...
class mob_config_settings(osv.osv_memory):
    ...
    _columns = {
        ...
        'mob_credit_product': fields.many2one('product.product',"Credit Product",
            help="""Service type product used in Credit."""),
    }
    def set_default_fields(self, cr, uid, ids, context=None):
        ...
        ir_values.set_default(cr, uid, 'product.product', 'mob_credit_product',
            config.mob_credit_product and config.mob_credit_product.id or False)
        return True
    ...
    def get_default_fields(self, cr, uid, ids, context=None):
        ...
        mob_credit_product = ir_values.get_default(cr, uid, 'product.product', 'mob_credit_product')
        return {'mob_discount_product':mob_discount_product,'mob_delivery_product':mob_delivery_product,'mob_coupon_product':mob_coupon_product,'mob_credit_product':mob_credit_product}
mob_config_settings()